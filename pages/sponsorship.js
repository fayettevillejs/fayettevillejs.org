    ...
    <Layout customStyles={styles.customLayoutPadding}>
      <div css={styles.textContentContainer}>
        ...
        <p css={styles.bottomSpacing(24)}>
          ...
          a couple appetizers for the group to share. Any money left over at the end of the year
          helps pay the Meetup dues ($180 / year) for that year, or is set aside for the following
          year. All money is handled through{' '}
        ...
        <p css={styles.bottomSpacing(24)}>
          ...
          throughout the year. If this is something your company is interested in, I like to handle
          these on a case by case basis. Please get in touch to discuss options!
        </p>
